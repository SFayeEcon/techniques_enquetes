...
/* On fait l'estimation des coefficients du  modèle logit liant les valeurs présentes de notre variable d'intérêt et nos variables explicatives */
...
run;  
/* On fait la prédiction des valeurs manquantes de notre variable d'intérêt à partir du modèle estimé*/
 ...
 /* On crée une nouvelle variable qui contient les valeurs pour les répondants à notre variable d'intérêt et les valeurs estimées pour les non répondants par modèle 
 logit */
 data Covid_data_10;
 	set Covid_data9;
